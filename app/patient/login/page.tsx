...
import { Shield, Users, Mail, Lock, AlertCircle, ArrowLeft } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-md mx-auto">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600 text-lg">Access your patient account</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-white to-purple-50 rounded-2xl shadow-xl p-8 border border-purple-100">
            ...
            <div className="mt-8 pt-6 border-t border-purple-100">
              <p className="text-gray-600 text-center font-medium">
                ...
                <Link href="/patient/signup" className="text-purple-600 hover:text-purple-700 font-bold underline">
                  Sign Up
                </Link>
              </p>
            </div>
