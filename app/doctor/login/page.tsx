...
import { Shield, Stethoscope, Mail, Lock, AlertCircle, ArrowLeft, User } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-md mx-auto">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600 text-lg">Access your verified doctor account</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-white to-blue-50 rounded-2xl shadow-xl p-8 border border-blue-100">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white py-4 rounded-xl font-bold hover:from-blue-700 hover:to-blue-800 transition-all shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed transform hover:-translate-y-0.5"
              >
                {loading ? (
            ...
            <div className="mt-8 pt-6 border-t border-blue-100">
              <p className="text-gray-600 text-center font-medium">
                ...
                <Link href="/doctor/signup" className="text-blue-600 hover:text-blue-700 font-bold underline">
                  Sign Up
                </Link>
              </p>
            </div>
